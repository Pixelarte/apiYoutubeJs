function classApiYoutube(a) {
    ...
    this.playlistId, this.playlistItems, this.checkAuth = function() {
        gapi.auth.authorize({
        ...
        a.execute(function(a) {
            if ("error" in a) console.log(a.error.message); else {
                ...
                c.execute(function(a) {
                    b.playlistItems = a.result.items, b.playlistItems ? b.listVideoYoutube() : b.errorListVideoYoutube();
                });
            }
        });
    };
